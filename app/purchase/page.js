...
const PACKS = [
  ...
  },
  {
    ...
    price: 400,
    credits: 12,
    description: '12 lessons — pay for 10. No expiry.',
    expiry: 'Use at your own pace',
    highlight: true,
  },
];
  ...
  return (
    <div style={{ minHeight:'100vh', background:'#f0f9f5', padding:'2rem 1rem' }}>
      <div style={{ maxWidth:400, margin:'0 auto' }}>
        ...
        <h1 style={{ fontSize:24, fontWeight:600, margin:'0 0 6px' }}>Get started</h1>
        <p style={{ fontSize:13, color:'#666', margin:'0 0 24px' }}>Choose a pack to begin playing.</p>
